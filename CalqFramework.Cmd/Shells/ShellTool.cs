...
public class ShellTool(IShell shell, string command) : ShellBase {
    ...
    public override string MapToHostPath(string internalPth) => Shell.MapToHostPath(internalPth);

    public override string MapToInternalPath(string hostPath) => Shell.MapToInternalPath(hostPath);
}
