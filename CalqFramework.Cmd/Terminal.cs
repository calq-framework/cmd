...
public static class Terminal {
    ...
    /// </summary>
    public static LocalTerminalConfigurationContext LocalTerminal { get; } = new();
    ...
    /// </summary>
    public static void CD(string path) => PWD = Path.GetFullPath(Path.Combine(PWD, path));
    ...
    /// </summary>
    public static ShellScript CMDV(string script) => new(LocalTerminal.Shell, script);
