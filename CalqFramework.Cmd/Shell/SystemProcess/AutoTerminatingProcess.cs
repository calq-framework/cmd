...
public class AutoTerminatingProcess : Process {
    ...
    static AutoTerminatingProcess() => AppDomain.CurrentDomain.ProcessExit += OnProcessExit;

    /// <summary>
    ///     Initializes a new AutoTerminatingProcess and registers it for automatic cleanup.
    /// </summary>
    public AutoTerminatingProcess() => _ = s_allProcesses.TryAdd(this, 0);
