# Calq CMD - HOWTO Guide

This guide covers how to use Calq CMD across four execution contexts:
- **Calq CMD** — Local shell-style scripting in C#
- **Calq CMD with Python** — Python interoperability via PythonToolServer
- **Calq CMD ASP.NET Core** — Web API integration with shell scripting
- **Calq CMD ASP.NET Core with Python** — Web API with Python backend
